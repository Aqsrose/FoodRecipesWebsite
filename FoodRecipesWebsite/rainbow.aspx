<%@ Page Title="" Language="C#" MasterPageFile="~/Blankpage.Master" AutoEventWireup="true" CodeBehind="rainbow.aspx.cs" Inherits="FoodRecipesWebsite.rainbow" %>
    ...
    <div class="container">
        ...
        <div class="innerContainer">
            <div class="headingContainer">
                <img src="recipes/rainbow.webp" alt="recipe image">
            </div>
            <div class="details">
                <h1 class="recipeTitle">Rainbow Rice Krispie Treats</h1>
