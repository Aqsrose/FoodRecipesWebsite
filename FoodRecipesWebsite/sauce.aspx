<%@ Page Title="" Language="C#" MasterPageFile="~/Blankpage.Master" AutoEventWireup="true" CodeBehind="sauce.aspx.cs" Inherits="FoodRecipesWebsite.sauce" %>
    ...
    <div class="container">
        ...
        <div class="innerContainer">
            <div class="headingContainer">
                <img src="recipes/sauce.webp" alt="recipe image">
            </div>
            <div class="details">
                <h1 class="recipeTitle">Classic Veloute Sauce</h1>
