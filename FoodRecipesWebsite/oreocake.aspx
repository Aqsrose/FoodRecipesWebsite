<%@ Page Title="" Language="C#" MasterPageFile="~/Blankpage.Master" AutoEventWireup="true" CodeBehind="oreocake.aspx.cs" Inherits="FoodRecipesWebsite.oreocake" %>
    ...
    <div class="container">
        ...
        <div class="innerContainer">
            <div class="headingContainer">
                <img src="recipes/oreo.webp" alt="recipe image">
            </div>
            <div class="details">
                <h1 class="recipeTitle">Oreo Cheesecake</h1>
